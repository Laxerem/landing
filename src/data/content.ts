...
export const content: SiteContent = {
  hero: {
    statusText: 'В активном поиске · Екатеринбург',
    firstName: 'Григорий',
    lastName: 'Воробьёв',
  ...
  about: {
    ...
    body: [
      'Реальные проекты выросли из учёбы в Колледже цифровых технологий — от Telegram-бота с живой аудиторией до бэкенд-сервиса для генеративных моделей с ролевой моделью и стриминговыми ответами. Работаю с базами данных, проектирую структуру сервисов и спокойно ухожу на уровень ниже, когда задача того требует.',
      'Подхожу к работе по принципу из моего слогана: ставлю цель и довожу её до результата, а не до «вроде работает». Ищу первый оффер или стажировку, где можно расти внутри команды.',
    ],
    facts: [
    ...
    stats: [
      ...
      { n: 24, suffix: '+', label: 'репозитория на GitHub' },
